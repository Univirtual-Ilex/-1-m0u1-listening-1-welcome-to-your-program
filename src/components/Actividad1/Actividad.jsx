...
// Refs de las areas
    ...
    return (
        <Container bgImage='./src/bg_actividad1.png' {...props} id="area">
            ...
            <AreasContainer >
                <Area title='University Campus' data-target="area_1" id="area_1" ref={area_1}/>
                <Area title='Classes' data-target="area_2" id="area_2" ref={area_2}/>
                <Area title='Introducing People' data-target="area_3" id="area_3" ref={area_3}/>
            </AreasContainer>
